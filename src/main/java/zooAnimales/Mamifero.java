...
public class Mamifero extends Animal {
    ...
    public static Animal crearCaballo(String nombre, int edad, String genero, Zona zona){
    ...
    public static Animal crearLeon(String nombre, int edad, String genero, Zona zona){
